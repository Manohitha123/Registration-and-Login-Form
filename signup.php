...
if(strlen($email)>50){  // Max 
   ...
   if($passwordConfirm ==''){
      ...
      $sql="SELECT * FROM usersdata WHERE (username='$username' or email='$email');";
...
//             $password = password_hash($password,PASSWORD_BCRYPT,$options);
            $result = mysqli_query($dbc,"INSERT INTO usersdata(fname,lname,username,email,password,date) values('$fname','$lname','$username','$email','$password','$date')");
...
?>
    ...
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> You have registered successfully . <br> <a href="login.php" style="color:#fff;">Login here... </a> </div>
      <?php } else { ?>
       <div class="signup_form">CREATE ACCOUNT
